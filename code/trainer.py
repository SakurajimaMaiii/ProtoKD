...
class ProtoKD(nn.Module):
    def __init__(self,cfg):
        ...
        #model
        self.model = VNet(n_channels=cfg['student_channels'], n_classes=self.num_cls, 
                                           n_filters=cfg['n_filters'],normalization='batchnorm')
        self.model.train()
        self.model.cuda()
        self.teacher_model = VNet(n_channels=cfg['teacher_channels'], n_classes=self.num_cls, 
                                        n_filters=cfg['n_filters'],normalization='batchnorm')
        ...
        self.train_loader = DataLoader(dataset=train_dataset,batch_size=cfg['batch_size'],
